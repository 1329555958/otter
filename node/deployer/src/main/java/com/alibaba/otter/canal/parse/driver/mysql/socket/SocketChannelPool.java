...
public abstract class SocketChannelPool {
        ...
        boot.group(group)
                ...
                .handler(new ChannelInitializer() {
                    ...
                    protected void initChannel(Channel arg0) throws Exception {
                        arg0.pipeline()
                                .addLast(new BusinessHandler());// 命令过滤和handler添加管理
                    }
                });
    }
    ...
    public static class BusinessHandler extends ChannelInboundHandlerAdapter {
        ...
        public void channelInactive(ChannelHandlerContext ctx) throws Exception {
            ...
            log.error("before null active={},open={},{}",channel.isActive(),channel.isOpen(),channel.toString());
        ...
        public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
            log.error("channel has a exception",cause);
            ctx.close();
        }
    }
}
